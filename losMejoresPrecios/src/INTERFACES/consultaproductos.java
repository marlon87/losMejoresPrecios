...
public class consultaproductos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 1130, 540));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       ...
       // String codigo = jTable1.getValueAt(fila, 0).toString();
        ...
        //Facturas.codigo_cliente.setText(codigo);
        //Facturas.nit.setText(nit);
        //Facturas.nombrecliente.setText(nombre);
        //Facturas.direccioncliente.setText(direccion);
        this.dispose();
...
private String[] getcolumnas() {
        ...
        String columna[] = new String[]{"Id", "Descripcion", "Categoria" ,"PRECIO VENTA", "existencia", "Tiempo Garantia"};
        return columna;
    }
    ...
    void actualizar_pendientes() {
        ...
        String sql ="select idproductos,descripcion,idcatfk,precioventa,existencia,tiempogarantia from productos";
