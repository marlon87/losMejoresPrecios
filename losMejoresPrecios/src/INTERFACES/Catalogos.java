...
public class Catalogos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        id_catologo = new javax.swing.JTextField();
        ...
        jLabel1.setText("REGISTRO CATALOGOS ");
        ...
        jLabel5.setText("Id Catalogo");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, 130, -1));
        jPanel1.add(id_catologo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 170, -1));
    ...
    private void AGREGARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AGREGARActionPerformed
        // Nuevo registro
        try {
            reg.setIdCatalogo(Integer.parseInt(this.id_catologo.getText()));
        ...
        cn = new conectarBD();
        String res = cn.ProcedimientoCatalogo(reg.getIdCatalogo(), reg.getDescripcion(), reg.getAccion());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            reg.setIdCatalogo(Integer.parseInt(jTable1.getValueAt(fila, 0).toString()));
        ...
        id_catologo.setText(String.valueOf(reg.getIdCatalogo()));
    ...
    void actualizar_pendientes() {
        ...
        String sql = "SELECT * FROM losMejoresPrecios.catalogos";
    ...
    private javax.swing.JTextField id_catologo;
