...
public class Consultaempleadosfactura extends javax.swing.JFrame {
     ...
     */
    public Consultaempleadosfactura() {
        initComponents();
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        // JOptionPane.showMessageDialog(null, "Fila seleccionada: "+jTable1.getValueAt(fila, 1).toString());
         ...
         Facturas.codigo_empleado_factu.setText(codigo);
         Facturas.nombreempleado_factu.setText(nombre);
         this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultaempleadosfactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Consultaempleadosfactura().setVisible(true);
            }
        });
    }
